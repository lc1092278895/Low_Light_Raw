...
class EnhanceNet(nn.Module):
    def __init__(self,channel=64):
        ...
        '''
        self.layer1 = nn.Sequential(nn.MaxPool2d(2),single_block1(32,64))#256  MAB: Mix Attention Block
        ...
        self.up1 = nn.ConvTranspose2d(256,128,2,2) # Convtranspose
        self.layer4 = nn.Sequential(single_block(256,128)) # CAB + Conv
